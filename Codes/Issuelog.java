...
public class Issuelog{
    ...
    int status;
	public Issuelog() { }
	public Issuelog (int a,int b,int c,Date d,Date e,Date f){ issue_id=a; book_id=b; student_id=c; date_issued=d; expec_return=e; return_date=f; }
    ...
    public Date getexpec_return() { return expec_return; }
